...
//edited by YellowD
Window_Base.prototype.drawActorClass = function(actor, x, y, align, width) {
    width = width || 168;
		align = align || "left";
    this.resetTextColor();
...
Window_Base.prototype.drawActorIcons = function(actor, x, y, width) {
  ...
  for (var i = 0; i < allCondition.length; i++) {
    this.drawIcon($dataStates[allCondition[i].conditionId].iconIndex, x + Window_Base._iconWidth * i, y + 2);
  }
};
...
Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    ...
    this.drawActorClass(actor, x, y, "right");
...
Window_ItemList.prototype.makeItemList = function() {
		...
		//test
	// console.log("$gameParty.allItems() = ");
	// console.log($gameParty.allItems());
