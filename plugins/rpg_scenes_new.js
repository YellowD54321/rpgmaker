...
Scene_Equip.prototype.onItemOk = function() {
	...
	console.log(this._itemWindow.item());
	console.log("this._slotWindow.index() = ");
	console.log(this._slotWindow.index());
    ...
    this.actor().changeEquip(this._slotWindow.index(), this._itemWindow.item());
		//Edited by YellowD
		if ( this._itemWindow.item().note != null && this._itemWindow.item().note != undefined && this._itemWindow.item().note != "" ) {
			RoguelikeBloodyEquipmentNoteEffect(this._itemWindow.item(), this._statusWindow._actor);
		};
    this._slotWindow.activate();
    this._slotWindow.refresh();
    this._itemWindow.deselect();
